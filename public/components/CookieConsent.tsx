    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-50 p-4 bg-white text-black shadow-lg animate-slideUp"
        >
              ...
              <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                <div className="flex-1">
                  ...
                  <p className="text-xs opacity-80">
                    Read our <Link href="/cookies" className="underline font-medium">Cookie Policy</Link> and <Link href="/privacy" className="underline font-medium">Privacy Policy</Link> to learn more.
                  </p>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full md:w-auto">
                  <button
                    ...
                    className="px-3 py-2 text-sm font-medium rounded-md transition-colors bg-transparent border border-gray-300 hover:bg-gray-100"
                  >
                    Decline All
                  </button>
                  ...
                  <button
                    ...
                    className="px-4 py-2 text-sm font-medium rounded-md transition-colors bg-[#e59500] text-white hover:bg-[#d48700]"
                  >
                    Accept All
                  </button>
                </div>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      >
                        <input 
                          ...
                          className="sr-only"
                        />
                        <div className="w-10 h-5 rounded-full bg-[#ffaa22] transition-colors"></div>
                        <span 
                          className={`absolute top-0.5 right-0.5 w-4 h-4 rounded-full bg-white shadow-md ${
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <label className="relative inline-block w-10 h-5 cursor-pointer">
                        <input 
                          ...
                          className="sr-only"
                        />
                        <div className={`w-10 h-5 rounded-full ${cookiePreferences.analytics ? 'bg-green-500' : 'bg-gray-300'} transition-colors`}></div>
                        <div className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white transition-transform ${cookiePreferences.analytics ? 'translate-x-5' : 'translate-x-0'}`}></div>
                      </label>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <label className="relative inline-block w-10 h-5 cursor-pointer">
                        <input 
                          ...
                          className="sr-only"
                        />
                        <div className={`w-10 h-5 rounded-full ${cookiePreferences.marketing ? 'bg-green-500' : 'bg-gray-300'} transition-colors`}></div>
                        <div className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white transition-transform ${cookiePreferences.marketing ? 'translate-x-5' : 'translate-x-0'}`}></div>
                      </label>
                    </div>
                  </div>
                    ...
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <label className="relative inline-block w-10 h-5 cursor-pointer">
                        <input 
                          ...
                          className="sr-only"
                        />
                        <div className={`w-10 h-5 rounded-full ${cookiePreferences.preferences ? 'bg-green-500' : 'bg-gray-300'} transition-colors`}></div>
                        <div className={`absolute top-0.5 left-0.5 w-4 h-4 rounded-full bg-white transition-transform ${cookiePreferences.preferences ? 'translate-x-5' : 'translate-x-0'}`}></div>
                      </label>
                    </div>
                  </div>
                </div>
      ...
      {showMinimized && !isVisible && consentGiven && (
        ...
        >
          <button
            ...
            className="p-3 rounded-full shadow-lg transition-all duration-300 ease-out transform hover:scale-110 bg-white text-gray-800 hover:bg-gray-100"
            style={{
