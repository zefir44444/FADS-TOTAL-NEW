      ...
      <section className="py-12 md:py-16 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center mb-8">
            ...
            <p className="text-left text-lg max-w-3xl mx-auto text-black mt-2">Не обязательно заполнять все поля, если у вас нет информации или вы не знаете, что именно вам нужно. Мы свяжемся с вами в течение 24 часов после отправки брифа по указанным вами контактам.</p>
