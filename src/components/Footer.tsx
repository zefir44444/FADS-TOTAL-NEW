      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
        ...
        >
            ...
            <nav className="flex flex-col gap-2 text-2lg items-end">
              <div className="flex items-center gap-3 justify-end">
                <ul className="flex items-center gap-3">
                  ...
                  <li className="opacity-90 font-medium">|</li>
                  <li>
          ...
          <div className="flex flex-col items-end mt-4 mb-4">
            ...
            <div className="flex items-center gap-4 mt-1" role="list" aria-label="Партнеры платежных систем">
              <div role="listitem">
                <a 
            ...
            {/* Платежные системы */}
            <div className="flex flex-wrap items-center justify-end gap-3 mt-4" role="list" aria-label="Поддерживаемые платежные системы">
              <div role="listitem">
                <Image 
