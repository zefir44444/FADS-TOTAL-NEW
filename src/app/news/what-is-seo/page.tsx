  ...
  return (
    <div className="prose prose-lg max-w-none">
      ...
      <div className="bg-gray-50 p-6 rounded-xl mb-8">
        ...
        <div className="mt-6 p-4 bg-[#e59500]/10 rounded-lg border-l-4 border-[#e59500]">
      ...
      <div className="mt-2 mb-8 p-4 bg-[#e59500]/10 rounded-lg border-l-4 border-[#e59500]">
        <p className="italic text-gray-700">
      ...
      <div className="bg-gray-50 p-6 rounded-xl mb-8">
        ...
        <p className="text-gray-700 font-semibold text-center my-6">
        ...
        <div className="text-center mt-6">
          <Link 
            ...
            className="inline-block bg-gradient-to-r from-[#e59500] to-[#840032] text-white font-bold py-3 px-8 rounded-full hover:shadow-lg transform transition hover:scale-105"
          >
