...
export const metadata: Metadata = {
  ...
  description: 'Comprehensive guide to optimize your website\'s speed, improve user experience, and boost SEO rankings with our actionable performance checklist.',
