...
export const metadata: Metadata = {
  title: 'FADS Digital Hub | Personal Website Development',
  description: 'Professional personal website development services. We create stunning personal websites that showcase your skills, portfolio, and professional journey.',
  keywords: ['personal websites', 'portfolio websites', 'personal branding', 'professional portfolio', 'personal web design'],
  openGraph: {
    title: 'FADS Digital Hub | Personal Website Development',
    description: 'Professional personal website development services. We create stunning personal websites that showcase your skills, portfolio, and professional journey.',
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: 'FADS Digital Hub Personal Website Development',
      },
    ],
    locale: 'en_FI',
    type: 'website',
